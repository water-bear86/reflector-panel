        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 flex flex-nowrap items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            ...
            <div className="hidden sm:flex items-center gap-1.5">
              ...
              <a href={`https://solscan.io/token/${STIMMY.mint}`} target="_blank" rel="noopener noreferrer" title="Explorer" aria-label="View on Solscan" className="w-9 h-9 flex items-center justify-center rounded-none bg-surface-700 border border-white/[0.04] hover:bg-surface-600 transition-colors">
