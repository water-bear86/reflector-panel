                      ...
                      <div key={i} className="rounded-none border border-white/[0.05] bg-surface-900/60 p-3 space-y-3">
                        ...
                        {rule.type === "distribute" && (
                          <>
                            ...
                            <input
                              ...
                              aria-label={`Rule ${i + 1} target token mint address`}
                            />
                                ...
                                {HOLDER_MODES.map((m) => {
                                  ...
                                  return (
                                    <button
                                      ...
                                      aria-label={`Rule ${i + 1} ${m.label} reach mode`}
                                      aria-pressed={active}
                                    >
                        ...
                        {rule.type === "buy-burn" && (
                          <input
                            ...
                            aria-label={`Rule ${i + 1} target buyback mint address`}
                          />
                        )}
                        {rule.type === "send" && (
                          <input
                            ...
                            aria-label={`Rule ${i + 1} target destination wallet address`}
                          />
                        )}
                      </div>
                    ))}
                    ...
                    {POLL_INTERVAL_PRESETS.map((p) => {
                      ...
                      return (
                        <button
                          ...
                          aria-label={`${p.label} check interval`}
                          aria-pressed={active}
                        >
